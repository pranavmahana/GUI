...
class VibrationAnalyzer:
    def __init__(self, root):
        ...
        self.plot_glevels_button = tk.Button(self.input_frame, text="Plot G-levels", command=self.plot_glevels)
        self.plot_glevels_button.grid(row=6, column=0, columnspan=2)
